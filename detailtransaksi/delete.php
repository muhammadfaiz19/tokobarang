...
if (isset($_POST['submitted'])==1 && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dat = $obj->deleteDetailtransaksi($id);
    $msg = getJSON($dat);
...
?>
    ...
    if($msg===true){ 
        ...
        echo '<meta http-equiv="refresh" content="3;url='.base_url().'detailtransaksi/">';
    } elseif($msg===false) {
    ...
    <h2><strong>detailtransaksi</strong> <small>Delete Data</small> </h2>
    </div>
    <hr/>
